...
export default function RestaurantDetail() {
  ...
  const restaurant = {
    ...
    priceRange: "$$",
    description: "Classic American diner serving breakfast all day and home-style comfort food in a casual atmosphere.",
    menu: [
      {
        category: "Breakfast",
        items: [
          { id: 1, name: "Classic Breakfast", price: 12.99, description: "Eggs, bacon, toast, and hash browns" },
          { id: 2, name: "Pancake Stack", price: 10.99, description: "Three fluffy pancakes with maple syrup" }
        ]
      },
      {
        category: "Main Course",
        items: [
          { id: 3, name: "Burger", price: 14.99, description: "1/2 lb beef patty with lettuce, tomato, and fries" },
          { id: 4, name: "Grilled Chicken", price: 16.99, description: "Herb-marinated chicken with seasonal vegetables" }
        ]
      }
    ]
  };
                ...
                <div className="grid gap-4">
                  {category.items.map((item) => (
                    <div key={item.id} className="flex justify-between items-start">
                      ...
                      <span className="font-medium text-yellow-500">${item.price}</span>
                    </div>
                  ))}
                </div>
              </div>
