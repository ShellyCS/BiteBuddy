...
export default function Checkout() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const restaurantResponse = await restaurantsApi.getById(cart.restaurantId.toString());
        ...
        setSuggestedItems(suggested.map(item => ({
          ...item,
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="mb-8">
        <Link to="/" className="flex items-center text-gray-600 hover:text-yellow-500">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-6">
              ...
              <div className="space-y-4">
                ...
                <div className="border-t pt-4 flex justify-between font-bold">
                  <span>Total</span>
                  <span>₹{(cart.total + 50 + cart.total * 0.05).toFixed(2)}</span>
                </div>
                <button
